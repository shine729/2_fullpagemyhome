  ...
  function initialise(containerSelector, options) {
    ...
    function hashChangeHandler() {
      if (!isScrolling && !options.lockAnchors) {
        ...
        // console.log("hytext--------" + anchors);
        // console.log("hytext--------" + sectionAnchor);
      ...
      mySectionNum = sectionAnchor.slice(1, 2); //s3 ->3
      // console.log(document.getElemtById("menu3").offsetLeft); //1043
      document.getElementById("nav_bar").style.left =
        document.getElementById("menu" + mySectionNum).offsetLeft + "px";
      // document.getElementById("nav_bar").style.width =
      // document.getElementById("menu" + mySectionNum).offsetwidth + "px";
      document.getElementById("nav_bar").style.width =
        document.getElementById("menu" + mySectionNum).offsetWidth + "px";
      ...
      document.getElementById("menu" + mySectionNum).style.color = "orangered";
    }
